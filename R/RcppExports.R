...
sample_class_probabilities <- function(data, class_probs, phi_prior, cluster_labels, cat_count, num_clusters, num_cols) {
    .Call('_tagmmdi_sample_class_probabilities', PACKAGE = 'tagmmdi', data, class_probs, phi_prior, cluster_labels, cat_count, num_clusters, num_cols)
}
...
CountCatergories <- function(data) {
    .Call('_tagmmdi_CountCatergories', PACKAGE = 'tagmmdi', data)
}
...
mdi_cat_cat <- function(data_1, data_2, class_dist_prior_1, class_dist_prior_2, clust_weight_priors_1, clust_weight_priors_2, clust_labels_1, clust_labels_2, n_clust_1, n_clust_2, fix_vec_1, fix_vec_2, a_0, b_0, num_iter, burn, thinning) {
    .Call('_tagmmdi_mdi_cat_cat', PACKAGE = 'tagmmdi', data_1, data_2, class_dist_prior_1, class_dist_prior_2, clust_weight_priors_1, clust_weight_priors_2, clust_labels_1, clust_labels_2, n_clust_1, n_clust_2, fix_vec_1, fix_vec_2, a_0, b_0, num_iter, burn, thinning)
}

mdi_gauss_cat <- function(cont_data, cat_data, mu_0, lambda_0, scale_0, nu_0, a_0, b_0, clust_wgt_priors_gauss, clust_wgt_priors_cat, phi_prior, clust_labels_gauss, clust_labels_cat, n_clust_gauss, n_clust_cat, fix_vec_1, fix_vec_2, n_iter, burn, thin, allow_outliers = FALSE, t_df = 4.0, normalise = FALSE, u_1 = 2, v_1 = 10, rate_gauss_0 = 1L, rate_cat_0 = 1L) {
    .Call('_tagmmdi_mdi_gauss_cat', PACKAGE = 'tagmmdi', cont_data, cat_data, mu_0, lambda_0, scale_0, nu_0, a_0, b_0, clust_wgt_priors_gauss, clust_wgt_priors_cat, phi_prior, clust_labels_gauss, clust_labels_cat, n_clust_gauss, n_clust_cat, fix_vec_1, fix_vec_2, n_iter, burn, thin, allow_outliers, t_df, normalise, u_1, v_1, rate_gauss_0, rate_cat_0)
}

mdi_gauss_gauss <- function(data_1, data_2, mu_0_1, lambda_0_1, scale_0_1, df_0_1, mu_0_2, lambda_0_2, scale_0_2, df_0_2, clust_weight_priors_1, clust_weight_priors_2, clust_labels_1, clust_labels_2, n_clust_1, n_clust_2, fix_vec_1, fix_vec_2, a_0, b_0, num_iter, burn, thinning, outlier_1 = FALSE, t_df_1 = 4.0, outlier_2 = FALSE, t_df_2 = 4.0, record_posteriors = FALSE, normalise_1 = FALSE, normalise_2 = FALSE, u_1 = 2, v_1 = 10, u_2 = 2, v_2 = 10, rate_1_0 = 1L, rate_2_0 = 1L, save_results = FALSE, load_results = FALSE, num_load = 0L) {
...
PredictClusterMembership <- function(probabilities) {
    .Call('_tagmmdi_PredictClusterMembership', PACKAGE = 'tagmmdi', probabilities)
}
