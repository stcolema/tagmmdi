...
Rcpp::List mdi_gauss_gauss(arma::mat data_1,
  ...
  for(arma::uword i = 0; i < num_iter; i++){
    ...
    entropy_cw(i - num_load) = CalcEntropy(clust_weights_1);
    ...
    for(arma::uword j = 0; j < n; j++){
      ...
      if(outlier_1){
        ...
        predicted_outlier_1 = PredictIndex(curr_outlier_prob_1);
      ...
      if(outlier_2){
        ...
        predicted_outlier_2 = PredictIndex(curr_outlier_prob_2);
